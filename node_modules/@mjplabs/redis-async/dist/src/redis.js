...
exports.createAsyncClient = void 0;
var redis_1 = require("redis");
var bluebird_1 = require("bluebird");
function createAsyncClient() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
    var client = bluebird_1.promisifyAll(redis_1.createClient.apply(void 0, args));
